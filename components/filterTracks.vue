<template>
  ...
  >
    <h1 class="hidden lg:block headline">Music</h1>
    <fieldset class="w-full flex flex-col gap-4 text-sm">
      <div class="w-full relative sm:w-4/5 sm:mx-auto md:w-1/2 lg:w-3/4">
        <IconsSearch
        ...
        <input
          @input="searchTrack"
          type="text"
          class="search w-full lg:text-xl lg:pl-9 lg:py-3"
          v-model="search"
          placeholder="Search for a track..."
        />
      </div>
      <div
        class="flex justify-evenly lg:w-3/4 lg:mx-auto lg:flex-col lg:items-start lg:gap-2"
      >
